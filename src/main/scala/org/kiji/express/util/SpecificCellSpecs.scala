...
object SpecificCellSpecs {
  val CELLSPEC_OVERRIDE_CONF_KEY = "kiji.express.input.cellspec.overrides"
  ...
  def serializeOverrides(
    ...
    serializeMap(collectOverrides(columns))
  }
  ...
  private def serializeMap(
    ...
    // Write teh properties to an XML string.
  ...
  def deserializeOverrides(
    ...
    buildCellSpecs(table.getLayout, deserializeMap(serializedMap))
  }
